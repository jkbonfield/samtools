...
(for i in `seq 1 100000`;do ASAN_OPTIONS=allow_addr2line=1:abort_on_error=1:detect_leaks=0 ./fuzz_mpileup corpus_in/ -rss_limit_mb=12560 -timeout=1 -max_total_time=10;done) 2>&1; # | tee /tmp/fuzz.out
